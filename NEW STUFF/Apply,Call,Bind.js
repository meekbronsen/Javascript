...
// The call method. it took the info function and bound it to game object.
// function info(){
//     console.log(`${this.title} was released in ${this.year}`);
// };
//
//info.call(game) // connects the object, sets `this` to point to the object
...
// info.apply(game,['playstation','Kratos']) //Takes the arguments inside an array literals
...
gameInfo() // we are now using one word to call the call the whole thing.